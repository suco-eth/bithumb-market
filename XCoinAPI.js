...
const XCoinAPI = class {
  ...
  xcoinApiCall(endPoint, params) {
    ...
    const httpHeaders = this._getHttpHeaders(endPoint, rgParams, this.api_key, this.api_secret);
  ...
  _getHttpHeaders(endPoint, rgParams, api_key, api_secret) {
    ...
    return {
      "Api-Key": api_key,
      "Api-Sign": base64_encode(hmacSHA512(endPoint + chr(0) + strData + chr(0) + nNonce, api_secret).toString()),
      "Api-Nonce": nNonce,
    };
  }
  usecTime() {
